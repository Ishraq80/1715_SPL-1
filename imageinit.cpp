...
// g++ imageinit.cpp -IC:/openslide-bin-4.0.1.2-windows-x64/openslide-bin-4.0.1.2-windows-x64/include -LC:/openslide-bin-4.0.1.2-windows-x64/openslide-bin-4.0.1.2-windows-x64/lib -lopenslide -o test.exe